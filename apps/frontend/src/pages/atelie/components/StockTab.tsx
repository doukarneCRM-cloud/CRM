        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50/70 text-xs text-gray-500">
            <tr>
              ...
              <th className="px-3 py-3 text-right font-medium">Low at</th>
            ...
            {rows.map((m) => {
              ...
              return (
                <tr key={m.id} className="border-t border-gray-100">
                  ...
                  <td className="px-3 py-2.5 capitalize text-gray-500">{m.category}</td>
                  ...
                  <td className="px-3 py-2.5 text-right text-gray-500">{m.lowStockThreshold}</td>
